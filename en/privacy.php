...
<div class="services-breadcrumb" id="privacy">
...
<div class="container">
	<div class="row">
			<div class="wthree_head_section">
				<h3 class="w3l_header w3_agileits_header">sinobectrading.com <span> Privacy Policy</span></h3>
			</div>
			<div class="aboutfocusinside">
				...
				<div id="pcnt">
					...
					<div>
						sinobectrading.com
						<ul>
							<li>4455 Rue Cousens, Saint-Laurent,H4S 1X5</li>
							<li>Saint-Laurent,H4S 1X5</li>
							<li>Canada</li>
